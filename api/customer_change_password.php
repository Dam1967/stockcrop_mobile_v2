...
if ($customerId <= 0 || empty($currentPassword) || empty($newPassword)) {
...
$stmt2 = $conn->prepare("UPDATE customers SET password = ? WHERE id = ?");
$stmt2->bind_param("si", $hashedPassword, $customerId);
